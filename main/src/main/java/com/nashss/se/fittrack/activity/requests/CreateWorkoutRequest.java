...
public class CreateWorkoutRequest {
    ...
    public List<Exercise> getExerciseList(){return copyToList(exerciseList);}
    ...
    public static class Builder{
        ...
        public CreateWorkoutRequest build(){return new CreateWorkoutRequest(name, date, notes, exerciseList);}
    }
}
